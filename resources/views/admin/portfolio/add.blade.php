...
<div  class="app-content">
    <div class="d-flex align-items-center mb-3">
        <div>
            ...
            <h1 class="page-header mb-0"> Portfolio Add</h1>
        </div>
    </div>
    <hr class="mb-4">
    <div class="container">
                            ...
                            <div class="card-body">
                                <form  action="{{ route('portfolio.store') }}" class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" name="portfolio_tag" class="form-control" id="portfolio_tag"  placeholder="Enter Your Name" >
                                        @error('portfolio_tag')
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <input type="text" name="project_name" class="form-control" id="project_name"  placeholder="Enter Your Designation" >
                                        @error('project_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="project_tag" class="form-control" id="project_tag">
                                        @error('project_tag')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="project_dev_name" class="form-control" id="project_dev_name">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="project_create" class="form-control" id="project_create">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class=" mt-3">
                                            <select class="js-example-basic-single form-control" multiple name="tags[]">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="project_video_link" class="form-control" id="project_video_link">
